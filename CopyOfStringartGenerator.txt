...
/**
 * Beschreiben Sie hier die Klasse CopyOfStringartGenerator.
 * 
 * @author (Ihr Name) 
 * @version (eine Versionsnummer oder ein Datum)
 */
public class CopyOfStringartGenerator
{
    private Data data;
    ...
    /**
     * Konstruktor für Objekte der Klasse CopyOfStringartGenerator
     */
    public CopyOfStringartGenerator(Data pData, Queue<int[]> pLineOrder)
    {
        data = pData;
